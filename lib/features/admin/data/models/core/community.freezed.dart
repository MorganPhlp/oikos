...
mixin _$Community {
 ...
 String get code;@JsonKey(name: 'nom') String get name;@JsonKey(name: 'entreprise_id') String get companyId; String? get description;@JsonKey(name: 'nombre_membres') int? get membersCount;@JsonKey(name: 'bilan_moyen') double? get avgScore;@JsonKey(name: 'logo_url') String? get logoUrl;@JsonKey(name: 'couleurhex') String? get colorHex;@JsonKey(name: 'plant_xp') int? get plantXp;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Community&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.description, description) || other.description == description)&&(identical(other.membersCount, membersCount) || other.membersCount == membersCount)&&(identical(other.avgScore, avgScore) || other.avgScore == avgScore)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl)&&(identical(other.colorHex, colorHex) || other.colorHex == colorHex)&&(identical(other.plantXp, plantXp) || other.plantXp == plantXp));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,code,name,companyId,description,membersCount,avgScore,logoUrl,colorHex,plantXp);

@override
String toString() {
  return 'Community(code: $code, name: $name, companyId: $companyId, description: $description, membersCount: $membersCount, avgScore: $avgScore, logoUrl: $logoUrl, colorHex: $colorHex, plantXp: $plantXp)';
}
...
@useResult
$Res call({
 String code,@JsonKey(name: 'nom') String name,@JsonKey(name: 'entreprise_id') String companyId, String? description,@JsonKey(name: 'nombre_membres') int? membersCount,@JsonKey(name: 'bilan_moyen') double? avgScore,@JsonKey(name: 'logo_url') String? logoUrl,@JsonKey(name: 'couleurhex') String? colorHex,@JsonKey(name: 'plant_xp') int? plantXp
});
...
/// Create a copy of Community
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? name = null,Object? companyId = null,Object? description = freezed,Object? membersCount = freezed,Object? avgScore = freezed,Object? logoUrl = freezed,Object? colorHex = freezed,Object? plantXp = freezed,}) {
...
as String?,plantXp: freezed == plantXp ? _self.plantXp : plantXp // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code, @JsonKey(name: 'nom')  String name, @JsonKey(name: 'entreprise_id')  String companyId,  String? description, @JsonKey(name: 'nombre_membres')  int? membersCount, @JsonKey(name: 'bilan_moyen')  double? avgScore, @JsonKey(name: 'logo_url')  String? logoUrl, @JsonKey(name: 'couleurhex')  String? colorHex, @JsonKey(name: 'plant_xp')  int? plantXp)  $default,) {final _that = this;
switch (_that) {
case _Community():
return $default(_that.code,_that.name,_that.companyId,_that.description,_that.membersCount,_that.avgScore,_that.logoUrl,_that.colorHex,_that.plantXp);}
}
...
class _Community implements Community {
  const _Community({required this.code, @JsonKey(name: 'nom') required this.name, @JsonKey(name: 'entreprise_id') required this.companyId, required this.description, @JsonKey(name: 'nombre_membres') this.membersCount = 0, @JsonKey(name: 'bilan_moyen') this.avgScore = 0, @JsonKey(name: 'logo_url') this.logoUrl, @JsonKey(name: 'couleurhex') this.colorHex = '#FFFFFF', @JsonKey(name: 'plant_xp') this.plantXp = 0});
...
@override@JsonKey(name: 'plant_xp') final  int? plantXp;
...
/// Create a copy of Community
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = null,Object? name = null,Object? companyId = null,Object? description = freezed,Object? membersCount = freezed,Object? avgScore = freezed,Object? logoUrl = freezed,Object? colorHex = freezed,Object? plantXp = freezed,}) {
