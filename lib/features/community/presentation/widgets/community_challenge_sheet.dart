...
import 'package:oikos/features/community/presentation/widgets/community_challenge_card.dart';
...
class CommunityChallengesSheet extends StatefulWidget {
  ...
  @override
  State<CommunityChallengesSheet> createState() =>
      _CommunityChallengesSheetState();
}
...
class _CommunityChallengesSheetState extends State<CommunityChallengesSheet> {
  ...
  Future<void> _fetchActiveChallenges() async {
    try {
      ...
      if (mounted) {
        setState(() {
          _activeActionIds = (res as List)
              .map((e) => e['action_id'].toString())
              .toList();
        });
      }
    } catch (e) {
    ...
    return Column(
      ...
      children: [
        _buildBigChoiceButton(
          ...
          subtitle:
              "Rejoins les défis actifs et fais gagner des points à ta communauté",
          icon: Icons.list_alt,
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: isAlreadyActive || _isLoading
                        ? null
                        : () async {
                            setState(() => _isLoading = true);

                            try {
                              final dataSource = CommunityRemoteDataSource(
                              ...
                              if (mounted) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      "Le défi a été lancé avec succès ! 🎉",
                                    ),
                              ...
                              if (mounted) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text("Erreur lors du lancement."),
                                  ),
                                );
                              }
                            }
