...
_Utilisateurs _$UtilisateursFromJson(Map<String, dynamic> json) => _Utilisateurs(
...
Map<String, dynamic> _$UtilisateursToJson(_Utilisateurs instance) => <String, dynamic>{
  'id': instance.id,
