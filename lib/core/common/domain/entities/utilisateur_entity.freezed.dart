...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,pseudo,avatar,role,etatCompte,estCompteValide,impactScoreXp,co2EconomiseTotal,aAccepteCgu,communauteNom,hasCompletedBilan,objectif);

@override
String toString() {
  return 'UtilisateurEntity(id: $id, email: $email, pseudo: $pseudo, avatar: $avatar, role: $role, etatCompte: $etatCompte, estCompteValide: $estCompteValide, impactScoreXp: $impactScoreXp, co2EconomiseTotal: $co2EconomiseTotal, aAccepteCgu: $aAccepteCgu, communauteNom: $communauteNom, hasCompletedBilan: $hasCompletedBilan, objectif: $objectif)';
}
...
switch (_that) {
case _UtilisateurEntity() when $default != null:
return $default(_that.id,_that.email,_that.pseudo,_that.avatar,_that.role,_that.etatCompte,_that.estCompteValide,_that.impactScoreXp,_that.co2EconomiseTotal,_that.aAccepteCgu,_that.communauteNom,_that.hasCompletedBilan,_that.objectif);case _:
  return orElse();
...
switch (_that) {
case _UtilisateurEntity():
return $default(_that.id,_that.email,_that.pseudo,_that.avatar,_that.role,_that.etatCompte,_that.estCompteValide,_that.impactScoreXp,_that.co2EconomiseTotal,_that.aAccepteCgu,_that.communauteNom,_that.hasCompletedBilan,_that.objectif);}
}
